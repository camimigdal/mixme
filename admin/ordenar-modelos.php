                ...
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Orden Modelos</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    ...
                                    <p>Mueva los bloques arriba o abajo para establecer el orden en el sitio. El primer bloque tiene orden "1".</p>
                                    <ul class="list_orden list-unstyled" id="sortable">
                                        <?php $Obj->listaOrdenModelos(); ?>
                                    </ul>
                                </div>
                            </div>
                        </div>
          ...
          $(function() {
            $( "#sortable" ).sortable({
                update: function(event, ui) {
                        ...
                        $.ajax({
                            url: 'include/reordenar-modelos.php',
                            data: {"data": orden},
                            type: 'post'
                        }).done(function(data) {
                    });
