                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    ...
                                    <button type="button" class="btn btn-success btn-addon m-b-sm btn-rounded btn-lg" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Agregar Color</button>
                                    <!-- Modal -->
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                        <div class="form-group">
                                                            <input type="text" name="campo1" class="form-control" placeholder="Nombre del color" required>
                                                        </div>
                                                        <div class="form-group">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                function getEmployee() {
                    $.ajax({
                      type: "GET",  
                      url: "include/generar_colores.php",
                      dataType: "json",       
                      success: function(response)  
                      {
                        for (var i = 0; i < response.length; i++) {
                             var html_data = '<tr><td><a href="#" data-name="col_nombre" id="col_nombre" data-type="text" data-pk="'+response[i].col_id+'" class="editable editable-click ';
                             if(response[i].col_nombre=="") html_data += 'editable-empty">Empty</a></td>'; else html_data += '">'+response[i].col_nombre+'</a></td>';

                             html_data += '<td><a href="#" data-name="col_hexa" id="col_hexa" data-type="text" data-value="'+response[i].col_hexa+'" data-pk="'+response[i].col_id+'" class="editable editable-click ';
                             if(response[i].col_hexa=="") html_data += 'editable-empty">Empty</a></td>'; else html_data += '">'+response[i].col_hexa+'</a></td>';

                             html_data += '<td><a href="colores.php?action=delete&id='+response[i].col_id+'" data-confirm="Está seguro que desea eliminar?" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Eliminar</a></td></tr>';
                ...
                make_editable_col('#employee_grid','a#col_nombre','include/generar_colores.php?action=edit','Nombre');
                make_editable_col('#employee_grid','a#col_hexa','include/generar_colores.php?action=edit','Color fondo');
