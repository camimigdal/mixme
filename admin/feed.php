        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h1>Archivo Feed Facebook</h1>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="index.html">Home</a></li>
                            <li class="active">Archivo Feed Facebook</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">       
                                    ...
                                    <div class="alert alert-info" role="alert"> <strong>ÚLTIMO CRON GENERADO:</strong>  <?php $Obj->ultimoProceso('feed'); ?></div>

                                    <?php

                                    $file='../feed.xml';
                                    if (file_exists($file)) {
                                        echo '<p><i class="fa fa-file-code-o fa-4x"></i><br>Fecha del archivo: '.date("d-m-Y (H:i:s)", filectime($file)).'';
                                        echo '<br><a href="'.$file.'" download="'.$file.'" class="btn btn-warning btn-sm"><i class="fa fa-download"></i> Descargar</a></p><br><br>';
                                    }

                                    ?>
                                    <a href="../xml_feed.php" target="_blank" class="btn btn-danger btn-lg">GENERAR FEED MANUALMENTE</a>
