        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h1>Editar código descuento</h1>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="index.php">Home</a></li>
                            <li class="active">Editar código descuento</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                                ...
                                <div class="panel-body">
                                  ...
                                  <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <button type="submit" name="submit" value="agregar" class="btn btn-danger btn-lg">PUBLICAR</button>
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="codigo" value="<?php if(isset($_POST['codigo'])) echo $_POST['codigo']; else echo $contenido['codigo'];?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="descripcion" ><?php if(isset($_POST['descripcion'])) echo $_POST['descripcion']; else echo $contenido['descripcion']; ?></textarea>
                                                <script>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="descuento" value="<?php if(isset($_POST['descuento'])) echo $_POST['descuento']; else echo $contenido['porcentaje_descuento'];?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control date-picker" name="dates" value="<?php if(isset($_POST['dates'])) echo $_POST['dates']; else echo $contenido['validez']; ?>" required autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control m-b-sm" name="estado">
                                                    <?php if(isset($_POST['estado'])) $estado=$_POST['estado']; else $estado=$contenido['cp_status']; ?>
                                                    <option value="publicado" <?php if ($estado=='publicado') { echo 'selected'; }; ?>>Publicado</option>
                                                    <option value="papelera" <?php if ($estado=='papelera') { echo 'selected'; }; ?>>No publicado, en borrador</option>
                                                </select>
                                            </div>
                                        </div>
