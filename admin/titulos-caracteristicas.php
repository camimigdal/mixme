...
$Obj=new TitulosCaracteristicas; 
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h1>Títulos Descripción</h1>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="index.html">Home</a></li>
                            <li><a href="#">Referencias</a></li>
                            <li class="active">Títulos Descripción</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    ...
                                    <button type="button" class="btn btn-success btn-addon m-b-sm btn-rounded btn-lg" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Agregar Título</button>
                                    <!-- Modal -->
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                        <div class="form-group">
                                                            <input type="text" name="campo1" class="form-control" placeholder="Título" required>
                                                        </div>
                                                </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                function getEmployee() {
                    $.ajax({
                      type: "GET",  
                      url: "include/generar_titulos_caracteristicas.php",
                      dataType: "json",       
                      success: function(response)  
                      {
                        for (var i = 0; i < response.length; i++) {
                             var html_data = '<tr><td><a href="#" data-name="ct_titulo" id="ct_titulo" data-type="text" data-pk="'+response[i].ct_id+'" class="editable editable-click ';
                             if(response[i].ct_titulo=="") html_data += 'editable-empty">Empty</a></td>'; else html_data += '">'+response[i].ct_titulo+'</a></td>';


                             html_data += '<td><a href="titulos-caracteristicas.php?action=delete&id='+response[i].ct_id+'" data-confirm="Está seguro que desea eliminar?" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Eliminar</a></td></tr>';
                ...
                make_editable_col('#employee_grid','a#ct_titulo','include/generar_titulos_caracteristicas.php?action=edit','Nombre');
