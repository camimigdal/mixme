    ...
    <body class="page-header-fixed small-sidebar">
                ...
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Iconos Mixer</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <p>ICONOS: <strong>(.SVG)</strong></p>
                                    <form action="upload-iconos.php" class="dropzone" id="myDropzone">
                                        <div class="fallback">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                    ...
                    $.ajax({
                      ...
                      success: function(response)  
                      {
                        ...
                        for (var i = 0; i < response.length; i++) {
                             ...
                             html_data += '<tr><td><img src="../img/iconos/'+response[i].ic_nombre+'" width="40px"></td>';

                             html_data += '<td><a href="#" data-name="ic_titulo" id="ic_titulo" data-type="text" data-pk="'+response[i].ic_id+'" class="editable editable-click ';
                             if(response[i].ic_titulo=="") html_data += 'editable-empty">Empty</a></td>'; else html_data += '">'+response[i].ic_titulo+'</a></td>';
                             
                             html_data += '<td><a href="iconos.php?action=delete&imagen='+response[i].ic_nombre+'" data-confirm="Está seguro que desea eliminar?" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Eliminar</a></td></tr>';
                         };
                ...
                make_editable_col('#employee_grid','a#ic_titulo','include/iconos.php?action=edit','Título');
