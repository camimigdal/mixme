    ...
    <body class="page-header-fixed small-sidebar">
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-12">
                            <button type="button" class="btn btn-success btn-addon btn-rounded btn-lg" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Agregar categoría</button>
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                            <select name="mayorista" id="mayorista" class="form-control">
                                                                <option value="0" selected>Minorista</option>
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <menu id="nestable-menu" class="no-m no-p m-b-sm">
                                        ...
                                        <button type="button" class="btn btn-primary" data-action="collapse-all">Minimizar todos</button>
                                    </menu>
                                    <div class="row">
                                        <div class="col-12 col-md-4 col-md-offset-1">
                                            <div class="dd" id="nestable">
                                                <ol class="dd-list">
                                                    <?php $Obj->loopCategorias(); ?>
                                                </ol>
                                            </div>
                                        </div>
        ...
        <script type="text/javascript">
            $( document ).ready(function() {
                ...
                function make_editable_select_mayo(table_selector,column_selector,ajax_url,title) {
                    $(table_selector).editable({   
                        ...
                        type: "POST",
                        source: [
                            {value: '0', text: 'Minorista'},
                            {value: '1', text: 'Mayorista'}
                        ],
                        showbuttons: false,
                        dataType: 'json',
                        success: function(response)  
                ...
                make_editable_col('#nestable','a#ct_titulo','include/generar_categoria.php?action=edit','Nombre');
                make_editable_select_mayo('#nestable','a#ct_mayorista','include/generar_categoria.php?action=edit','Para usuario:');
