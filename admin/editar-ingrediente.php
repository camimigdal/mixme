                ...
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li><a href="ingredientes-mixer.php">Ingredientes</a></li>
                            <li class="active">Edición de ingrediente</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                                        ...
                                        <div class="col-xs-12 col-md-10">
                                            <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <?php   if(isset($_POST['categoria'])) $categoria=implode(",", $_POST['categoria']); else $categoria=$contenido['pd_categoria'];
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select class="form-control" id="icono" name="icono" required>
                                                                <?php 
                                                                if(isset($_POST['icono'])) $icono=$_POST['icono']; else $icono=$contenido['pd_icono'];
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <?php   if(isset($_POST['prop'])) $propiedades=implode(",", $_POST['prop']); else $propiedades=$contenido['pd_componentes'];
                                                        ...
                                                        <div class="col-sm-10 col-sm-offset-2">
                                                            <div class="row">
                                                                <div class="col-xs-12 col-md-3">
                                                                    ...
                                                                    <input class="form-control" name="kcal" type="number" step="0.01" value="<?php if(isset($_POST['kcal'])) echo $_POST['kcal']; else echo $contenido['kcal']; ?>" />
                                                                </div>

                                                                <div class="col-xs-12 col-md-3">
                                                                    <label for="hidratos_carbono">Hidratos carbono</label>
                                                                    <input class="form-control" name="hidratos_carbono" type="number" step="0.01" value="<?php if(isset($_POST['hidratos_carbono'])) echo $_POST['hidratos_carbono']; else echo $contenido['hidratos_carbono']; ?>" />
                                                                </div>

                                                                <div class="col-xs-12 col-md-3">
                                                                    <label for="proteinas">Proteinas</label>
                                                                    <input class="form-control" name="proteinas" type="number" step="0.01" value="<?php if(isset($_POST['proteinas'])) echo $_POST['proteinas']; else echo $contenido['proteinas']; ?>" />
                                                                </div>

                                                                <div class="col-xs-12 col-md-3">
                                                                    <label for="grasas_totales">Grasas totales</label>
                                                                    <input class="form-control" name="grasas_totales" type="number" step="0.01" value="<?php if(isset($_POST['grasas_totales'])) echo $_POST['grasas_totales']; else echo $contenido['grasas_totales']; ?>" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-10 col-sm-offset-2">
                                                            <div class="row">
                                                                <div class="col-xs-12 col-md-3">
                                                                    ...
                                                                    <input class="form-control" name="grasas_saturadas" type="number" step="0.01" value="<?php if(isset($_POST['grasas_saturadas'])) echo $_POST['grasas_saturadas']; else echo $contenido['grasas_saturadas']; ?>" />
                                                                </div>

                                                                <div class="col-xs-12 col-md-3">
                                                                    <label for="grasas_trans">Grasas trans</label>
                                                                    <input class="form-control" name="grasas_trans" type="number" step="0.01" value="<?php if(isset($_POST['grasas_trans'])) echo $_POST['grasas_trans']; else echo $contenido['grasas_trans']; ?>" />
                                                                </div>

                                                                <div class="col-xs-12 col-md-3">
                                                                    <label for="grasas_monoinsaturadas">Grasas monoinsaturadas</label>
                                                                    <input class="form-control" name="grasas_monoinsaturadas" type="number" step="0.01" value="<?php if(isset($_POST['grasas_monoinsaturadas'])) echo $_POST['grasas_monoinsaturadas']; else echo $contenido['grasas_monoinsaturadas']; ?>" />
                                                                </div>

                                                                <div class="col-xs-12 col-md-3">
                                                                    <label for="grasas_poliinsaturadas">Grasas poliinsaturadas</label>
                                                                    <input class="form-control" name="grasas_poliinsaturadas" type="number" step="0.01" value="<?php if(isset($_POST['grasas_poliinsaturadas'])) echo $_POST['grasas_poliinsaturadas']; else echo $contenido['grasas_poliinsaturadas']; ?>" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-10 col-sm-offset-2">
                                                            <div class="row">
                                                                <div class="col-xs-12 col-md-3">
                                                                    ...
                                                                    <input class="form-control" name="colesterol" type="number" step="0.01" value="<?php if(isset($_POST['colesterol'])) echo $_POST['colesterol']; else echo $contenido['colesterol']; ?>" />
                                                                </div>

                                                                <div class="col-xs-12 col-md-3">
                                                                    <label for="fibra_alimentaria">Fibra alimentaria</label>
                                                                    <input class="form-control" name="fibra_alimentaria" type="number" step="0.01" value="<?php if(isset($_POST['fibra_alimentaria'])) echo $_POST['fibra_alimentaria']; else echo $contenido['fibra_alimentaria']; ?>" />
                                                                </div>

                                                                <div class="col-xs-12 col-md-3">
                                                                    <label for="sodio">Sodio</label>
                                                                    <input class="form-control" name="sodio" type="number" step="0.01" value="<?php if(isset($_POST['sodio'])) echo $_POST['sodio']; else echo $contenido['sodio']; ?>" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <?php  $Obj->variacionesProdMixer($id); ?>
