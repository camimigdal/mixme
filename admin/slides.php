    ...
    <body class="page-header-fixed small-sidebar">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <p>TAMAÑO DE SLIDE: <strong>(.JPG) 1920x1195px</strong></p>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                make_editable_col('#employee_grid','a#sl_texto_btn','include/slides.php?action=edit','Texto botón');
                make_editable_col('#employee_grid','a#sl_titulo','include/slides.php?action=edit','Título');
                make_editable_col('#employee_grid','a#sl_copete','include/slides.php?action=edit','Copete');
