        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h1>Ordenar Nuestras Mezclas</h1>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="index.php">Home</a></li>
                            <li class="active">Ordenar Nuestras Mezclas</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <p>Mueva las fotos para establecer el orden de aparición en el sitio. La primer foto tiene el orden "1".</p>
                                    <ul class="list_orden list-unstyled" id="sortable">
                                        <?php $Obj->listaOrdenExclusivos(); ?>
                                    </ul>
                                </div>
                            </div>
                        </div>
          ...
          $(function() {
            $( "#sortable" ).sortable({
                update: function(event, ui) {
                        ...
                        $.ajax({
                            url: 'include/reordenar-exclusivos.php',
                            data: {"data": orden},
                            type: 'post'
                        }).done(function(data) {
                    });
