...
if (isset($_POST['submit'])) {
	$result=$ordenes->editarCuotas();
} 

$contenido=$ordenes->traerCuotas();
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    ...
                                    <div class="col-xs-12">
                                        <button name="submit" type="submit" value="agregar" class="btn btn-danger m-b-lg">ACTUALIZAR</button>
                                    </div>
                                    <div class="col-xs-7">
                                                    <div class="form-group">
                                                        <label for="cuotas" class="col-sm-4 control-label">Cuotas sin interes:</label>
                                                        <div class="col-sm-8">
                                                            <input name="cuotas" type="text" value="<?php if(isset($_POST['cuotas'])) echo $_POST['cuotas']; else echo $contenido['cuotas']; ?>" class="form-control"/>
                                                        </div>
                                                    </div>
                                </div>
                                </form>
