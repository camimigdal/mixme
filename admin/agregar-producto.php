                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                  ...
                                  <form method="post" enctype="multipart/form-data" class="form-horizontal" action="agregar-producto.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="checkbox">
                                                    <label>
                                                        <?php if(isset($_POST['destacado'])) $destacado=$_POST['destacado']; else $destacado='';?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="checkbox">
                                                    <label>
                                                        <?php if(isset($_POST['exclusivo'])) $exclusivo=$_POST['exclusivo']; else $exclusivo='';?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="checkbox">
                                                    <label>
                                                        <?php if(isset($_POST['mayorista'])) $mayorista=$_POST['mayorista']; else $mayorista='';?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="peso" value="<?php if(isset($_POST['peso'])) echo $_POST['peso'];?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="descuento" value="<?php if(isset($_POST['descuento'])) echo $_POST['descuento'];?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                                <?php  if(isset($_POST['varia'],$_POST['valor'],$_POST['precio'],$_POST['stock'],$_POST['cod'])) {
                                                            ...
                                                            <div class="form-inline col-sm-10 col-sm-offset-2" id="div_1">
                                                                <hr />
