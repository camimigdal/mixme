            ...
            <div class="row justify-content-center">
                <div class="col-12 col-xl-10">
                    <div class="row">
                                    ...
                                    <div data-spy="scroll" data-target="#list-cat-mixer" data-offset="0" class="content-mixer">
                                        ...
                                        <div id="peso">
                                            <div class="mixer-catalog">
                                                ...
                                                <div class="mixer-packs-list">
                                                    <div class="custom-control custom-radio py-2 pr-3 pl-5">
                                                        <input type="radio" name="peso" id="peso1" data-id="1" class="custom-control-input" value="500" required>

                                                        <label class="custom-control-label label-packs-item pl-3 d-flex" for="peso1">
                                                            <div class="pr-3 col-3 text-center"><img alt="" title="" src="img/tubo-muestra-mixer.png" height="125"></div>
                                                            <div class="packs-item flex-grow-1">
                                                                <span>
                                                                    <h4 class="packs-item-price">500g</h4>
                                                                    <div class="packs-item-name">Tubo personalizable</div>
                                                                    <div class="packs-item-desc"><small>En el siguiente paso podés elegir el diseño que más te guste</small></div>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                    <div class="custom-control custom-radio py-2 pr-3 pl-5">
                                                        <input type="radio" name="peso" id="peso2" data-id="2" class="custom-control-input" value="350" required>

                                                        <label class="custom-control-label label-packs-item pl-3 d-flex" for="peso2">
                                                            <div class="pr-3 col-3 text-center"><img alt="" title="" src="img/doypack-muestra-mixer.png" height="100"></div>
                                                            <div class="packs-item flex-grow-1">
                                                                <span>
                        ...
                        <div class="col-12 col-lg-4 tubo-mixer animate__animated animate__tada">
                            <div class="contenido-tubo">
                            </div>
                        </div>
