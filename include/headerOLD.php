        ...
        <div class="top-bar">
            <div class="container">
                <div class="row d-flex justify-content-between align-items-center">
                    ...
                    <div class="col-auto col-lg-3 text-right p-0 ml-auto">
                        <div class="icons">
                            <ul class="list-inline m-0">
                                ...
                                <?php  } else { ?>
                                    <li class="list-inline-item"><a href="#" data-toggle="modal" data-target="#modLogin"><i class="fas fa-user-lock fa-lg px-1"></i> Mayoristas</a></li>
                                <?php } ?>
