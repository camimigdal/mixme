                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col wrap-form-signin">
                                ...
                                La <strong>compra mínima</strong> mayorista es de <strong>$10.000</strong>.
                                </div>
                                    <form class="form-signin" method="post">
                                        <input type="hidden" name="<?php echo $token_id; ?>" value="<?php echo $token_value; ?>" />
                                        <div class="form-group">
                                            <label for="inputNombre" class="sr-only">Nombre y Apellido</label>
                                            <input type="text" id="inputNombre" name="<?php echo $form_names['user']; ?>" class="form-control form-custom" placeholder="Nombre y Apellido" required autofocus>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputTel" class="sr-only">Teléfono</label>
                                            <input type="text" id="inputTel" name="<?php echo $form_names['telefono']; ?>" class="form-control form-custom" placeholder="Teléfono" required autofocus>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail" class="sr-only">Email</label>
                                            <input type="email" id="inputEmail" name="<?php echo $form_names['email']; ?>" class="form-control form-custom" placeholder="Email" required autofocus>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmpresa" class="sr-only">Empresa</label>
                                            <input type="text" id="inputEmpresa" name="<?php echo $form_names['empresa']; ?>" class="form-control form-custom" placeholder="Empresa" autofocus>
                                        </div>
